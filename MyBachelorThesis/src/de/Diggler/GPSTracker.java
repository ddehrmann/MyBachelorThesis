...
public class GPSTracker extends Service implements LocationListener{
	...
	//The minimum distance to change Updates in meters & minutes
	...
	public Location getLocation(){
		try{
			...
			if(!isGPSEnabled && !isNetworkEnabled){		//no network provider is enabled	
				Toast.makeText(getApplicationContext(), "neither GPS nor WiFi is enabled", Toast.LENGTH_LONG).show();
			}else{
	...
	public void showSettingsAlert(){
		...
		alertDialog.setTitle("GPS/WiFi status");
		//Setting Dialog Message
		alertDialog.setMessage("GPS/WiFi is not enabled. Do you want to go to settings menu?");
